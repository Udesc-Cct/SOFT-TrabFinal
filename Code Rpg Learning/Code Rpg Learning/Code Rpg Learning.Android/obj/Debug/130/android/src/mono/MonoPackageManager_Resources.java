...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Code Rpg Learning.Android.dll" comes first in this list. */
		"Code Rpg Learning.Android.dll",
		"Code Rpg Learning.dll",
		"FormsViewGroup.dll",
		"MaterialDesign.Icons.dll",
